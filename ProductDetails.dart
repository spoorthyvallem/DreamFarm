...
import 'tomatoes_model.dart';
export 'tomatoes_model.dart';

class TomatoesWidget extends StatefulWidget {
  const TomatoesWidget({Key? key}) : super(key: key);

  @override
  _TomatoesWidgetState createState() => _TomatoesWidgetState();
}

class _TomatoesWidgetState extends State<TomatoesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TomatoesModel());
  }
...
class TomatoesModel extends FlutterFlowModel {
